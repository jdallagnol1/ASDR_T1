// Alunos: João Dall Agnol, Caroline Lima, Joana FIgueredo.
...
public class AsdrSample {
   ...
   private void ListaDecl() {
      if (laToken == FUNC) {
         ...
         DeclFun();
         ListaDecl();
      } else if ((laToken == BOOLEAN) || (laToken == INT) || (laToken == DOUBLE)) {
         if (debug)
   ...
   private void TipoOuVoid() {
      if (laToken == VOID) {
         ...
         yyerror("Esperado INT, BOOLEAN, DOUBLE ou VOID");
      }
   }
   ...
   private void Tipo() {
      if (laToken == INT) {
         ...
         yyerror("Esperado INT, BOOLEAN, DOUBLE");
      }
   }
   ...
   private void RestoE() {
      if (laToken == '+') {
         if (debug)
            System.out.println("RestoE -> + T RestoE");
         verifica('+');
         T();
         RestoE();
      } else if (laToken == '-') {
         ...
         // vazio
         if (debug)
            System.out.println("RestoE -> Vazio");
      }
   }

   private void T() {
      if (debug)
         System.out.println("T -> F RestoT");
      F();
      RestoT();
   }
   ...
   private void RestoT() {
      if (laToken == '*') {
         if (debug)
            System.out.println("RestoT -> * F RestoT");
         verifica('*');
         F();
         RestoT();
      } else if (laToken == '/') {
         ...
         // vazio
         if (debug)
            System.out.println("RestoT -> Vazio");
      }
   }
